...
TOKEN = '8163299821:AAGy8RRumuJqFtDAwaVo-yGXaD9vfamh9WM'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@LSR.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -7197104935
CHANNEL_ID = -7197104935
error_channel_id = -7197104935
...
bot = telebot.TeleBot(8163299821:AAGy8RRumuJqFtDAwaVo-yGXaD9vfamh9WM)
REQUEST_INTERVAL = 1
...
def update_proxy_command(message):
    ...
    try:
        ...
        bot.send_message(chat_id, to update proxy: {e}")
...
def is_user_admin(7197104935):
    try:
        return bot.get_chat_member(7197104935).status in ['administrator', 'creator']
    except:
        return False
...
def approve_or_disapprove_user(message):
    ...
    chat_id = message.chat.id.7197104935
